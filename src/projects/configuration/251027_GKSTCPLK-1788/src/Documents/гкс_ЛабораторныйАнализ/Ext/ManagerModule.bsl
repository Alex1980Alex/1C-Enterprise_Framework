...
Процедура ТекстЗапросаВТПоказателиСертификации(Запрос, ТекстыЗапроса)
	...
	|ИЗ
	|	РегистрСведений.гкс_РезультатыНормативнойСертификацииНоменклатуры.СрезПоследних(&ДатаСреза,
...
Функция ТекстЗапросаРезультатаНормативнойСертификации()
	...
	|		ПО ЦБТ_ЛабораторныйАнализ.ТочкаМаршрута = ЦБТ_НормативнаяСертификацияНоменклатуры.ТочкаМаршрута
	...
	|ИЗ
	|	ВТ_НормативнаяСертификацияНоменклатуры КАК ВТ_НормативнаяСертификацияНоменклатуры
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_МмаксимуНормативнаяСертификацияНоменклатуры КАК
	|			ВТ_МмаксимуНормативнаяСертификацияНоменклатуры
