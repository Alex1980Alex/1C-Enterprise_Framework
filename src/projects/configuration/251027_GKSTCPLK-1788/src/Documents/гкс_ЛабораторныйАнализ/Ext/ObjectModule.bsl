...
//  ПоказателиДляЗаполнения - Неопределено - Показатели для заполнения
Процедура ЗаполнитьКачественныеПоказатели(ПоказателиДляЗаполнения = Неопределено) Экспорт
	
	Если ПоказателиДляЗаполнения = Неопределено Тогда 
	...
	Иначе
		Для Каждого ЭлементМассива Из ПоказателиДляЗаполнения Цикл
