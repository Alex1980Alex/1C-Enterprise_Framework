...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЗарегистрироватьТранспортноеСредствоДляУсиленногоКонтроля(РежимЗаписи);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если Не Отказ И Не ДополнительныеСвойства.Свойство("АРМПромежуточныйКомпозит") Тогда
...
Процедура ЗарегистрироватьТранспортноеСредствоДляУсиленногоКонтроля(РежимЗаписи)
	
	ДокументРегистрации = ПолучитьДокументРегистрации();
	Если Не РежимЗаписи = РежимЗаписиДокумента.Проведение
		Или Не ТребуетсяРегистрацияДляУсиленногоКонтроля(ДокументРегистрации) Тогда
		Возврат;
	КонецЕсли;	
	
	гкс_ВходнойКонтрольКачества.ЗарегистрироватьТранспортноеСредствоДляУсиленногоКонтроля(ДокументРегистрации, МестнаяДата);
...
Функция ТребуетсяРегистрацияДляУсиленногоКонтроля(ДокументРегистрации)
	...
	Возврат 
		...
		И ТипПробы = Перечисления.гкс_ТипыПроб.Единичная
