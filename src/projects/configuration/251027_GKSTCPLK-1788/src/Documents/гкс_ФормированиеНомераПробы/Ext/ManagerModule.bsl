...
//
Функция ДокументПромежуточногоКомпозита(ПараметрыСоздания) Экспорт
	...
	ДокументОбъект.ДополнительныеСвойства.Вставить("АРМПромежуточныйКомпозит", Истина);
...
Процедура СформироватьЛабораторныйАнализПоНеобходимости(ФормированиеНомераПробы,
	...
	Если ДополнительныеДанныеЗаполнения <> Неопределено Тогда 
		...
		ДанныеЗаполнения.Вставить("гкс_НазначениеИспользованияКачества", 
			ДополнительныеДанныеЗаполнения.гкс_НазначениеИспользованияКачества);

		ДанныеЗаполнения.Вставить("МассивПоказателей", 
			ДополнительныеДанныеЗаполнения.ПоказателиДляЗаполнения);
	Иначе 	
		ДанныеЗаполнения.Вставить("гкс_НазначениеИспользованияКачества", 
